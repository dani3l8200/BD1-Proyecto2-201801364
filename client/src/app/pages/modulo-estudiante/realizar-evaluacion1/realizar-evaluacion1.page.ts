...
@Component({
  selector: 'app-realizar-evaluacion1',
  templateUrl: './realizar-evaluacion1.page.html',
  styleUrls: ['./realizar-evaluacion1.page.scss'],
})
export class RealizarEvaluacion1Page implements OnInit {

  Intento2: ObtenerPreguntas[] = [
  ...
  ngOnInit() {
   ...
   this.preguntasService.ObtenerPreguntasPorEvaluacion1(localStorage.getItem("evaluacion2")).subscribe(
     (Intento2) => this.Intento2 = Intento2);
  }
